...
type
  ...
  private
    ...
    function GetTable(html: string; var pos: integer): boolean;
    { Private declarations }
  public
    { Public declarations }
    constructor Create;
...
Function TForm1.ParseHTML(HTMLs: String): String;
Var
...
Function TForm1.GetHTML(Number, Page: integer): String;
Var
  s_url, buf: String;
  IdHTTP1: TIdHTTP;
Begin
...
function TForm1.ParseNum(HTMLs: String): String;
Var
  Ps0, Ps1, Ps2: integer;
  Buff, Tag0: String;
Begin
...
function TForm1.GetLastNum(): string;
Var
  num, BufHTML: String;
  Page: integer;
begin
...
procedure TForm1.BtnLoadHtmlClick(Sender: TObject);
var
  Clmn: _ClmnTbl;
  Tbl: _TblParts;
  IdHTTP1: TIdHTTP;
...
function TParseHTML.GetTable(html: string; var pos: integer): boolean;
var
  row, clm: integer;
  Tag: _Tag;
...
begin
  ...
  begin
    ...
    if Tag.name = 'td' then
    begin
      Form1.StrGrd.Cells[clm, row] := Trim(Tag.text);
      Inc(clm);
    end;
  end;
end;
